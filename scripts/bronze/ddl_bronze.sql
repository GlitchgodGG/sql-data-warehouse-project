...
END 
--here, now we've created the stored procedure


--Hint: Save frequently used SQL code in stored procedures in database.

--running the stored procedure to load data into bronze layer tables
EXEC bronze.load_bronze

--Also track ETL bottlenecks, optimize performance, monitor trends, detect issues.
